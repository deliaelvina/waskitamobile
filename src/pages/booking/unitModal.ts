...
export class BookingUnitModalPage {
        ...
        (x: any) => {
          if (x.Error == true) {
            ...
            if (datas.status == 'A') {
              ...
              this.data.trx_amt = this.details.trx_amt;
  ...
  loadData() {
    //Load Data
    const lot_no = this.data.lot.replace("/", "__");

    this.http.get(this.url_api + "c_booking/getInfo/" + this.cons + "/" + this.data.entity + "/" + this.data.project + "/" + this.data.towerCd + "/" + this.data.level + "/" + lot_no, { headers: this.hd })
      .subscribe(
        (x: any) => {
          if (x.Error == true) {
            if (x.Status == 401) {
  ...
  loadPrice() {
    ...
    this.http.get(this.url_api + "c_booking/getPrice/" + this.cons + "/" + this.data.entity + "/" + this.data.project + "/" + lot_no, { headers: this.hd })
      .subscribe(
        (x: any) => {
          if (x.Error == true) {
            if (x.Status == 401) {
